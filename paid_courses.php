...
<head>
	...
	<title>Paid Course | Education Center</title>
		...
		<div class="about_course">
			<div class="info_course">
				...
				Mục đích cuối cùng của chúng tôi là sự hài lòng của bạn, hãy bỏ ra thời gian xem thử bài giảng của chúng tôi để đánh giá mức độ phù hợp của bạn.
				 Sau đó hãy quyết định xem có nên mua hay không.<br><br></p>
				 <em>Nếu bạn đã kết thúc khóa học này, hãy làm một bài khảo sát nhanh ở bên phải để chúng tôi có thể nâng cao chất lượng dịch vụ.</em> <br> <br>
